...
class SignUpCreateScreen extends GetWidget<SignUpCreateController> {
  SignUpCreateScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
                        ...
                        children: [
                          ...
                          Obx(() => CustomTextFormField(
                              ...
                              prefix: Container(
                                  ...
                                  child: CustomImageView(
                                      imagePath:
                                          ImageConstant.imgRectangle28118x18,
                                      height: 18.adaptSize,
                                      width: 18.adaptSize)),
                              prefixConstraints:
                                  BoxConstraints(maxHeight: 49.v),
            ...
            bottomNavigationBar: _buildEleven()));
  }
